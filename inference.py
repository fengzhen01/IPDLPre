...
parse.add_argument('--output', '-o', help='Output file path, default IPDLPre_result.txt',
                   default='IPDLPre_result.txt')
...
predictor.load_state_dict(torch.load('./Models/DNA/random_seed/42.ckpt'))
predictor.eval()
print("Done!")

# prediction process
results = []
print(f"=====Predicting DNA-binding sites=====")
